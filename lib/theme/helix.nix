colors: {
  ...
  "ui.linenr" = { fg = colors.base03; bg = colors.base01; };
  ...
  "ui.cursor" = { fg = colors.base04; modifiers = ["reversed"]; };
  "ui.cursor.primary" = { fg = colors.base05; modifiers = ["reversed"]; };
  ...
  "ui.bufferline.active" = { fg = colors.base06; bg = colors.base01; };
}
